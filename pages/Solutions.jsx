...
import ai1 from "../src/assets/images/ai1.png";
import ai2 from "../src/assets/images/ai2.png";
import ai3 from "../src/assets/images/ai3.png";
import ai4 from "../src/assets/images/ai4.png";
export default function Solutions() {
  return (
    <div>
      ...
      <div>
        <div className="pb-40 bg-[url('/../src/assets/images/bgimg10.png')] bg-cover bg-center bg-no-repeat ">
          <div className="flex justify-between w-[50%] pt-20 m-auto">
