      ...
      <div className="text-[80px] font-[700] flex items-center justify-center rounded-4xl mt-10 h-[500px] border border-amber-100">
        <div className="w-[100%] h-full m-auto text-center">
          ...
          >
            <SwiperSlide>
              {" "}
              <div className="pb-20 bg-[url('/assets/images/slide1.png')] bg-cover bg-center bg-no-repeat h-full w-full flex justify-center items-center rounded-4xl">
            ...
            <SwiperSlide>
              {" "}
              <div className="pb-20 bg-[url('/assets/images/slide2.png')] bg-cover bg-center bg-no-repeat h-full w-full flex justify-center items-center rounded-4xl">
                <p className="text-center text-[80px] font-[700] text-[#FFFFFF] w-[70%]">
                  {" "}
            ...
            <SwiperSlide>
              {" "}
              <div className="pb-20 bg-[url('/assets/images/slide3.png')] bg-cover bg-center bg-no-repeat h-full w-full flex justify-center items-center rounded-4xl">
            ...
            <SwiperSlide>
              {" "}
              <div className="pb-20 bg-[url('/assets/images/slide4.png')] bg-cover bg-center bg-no-repeat h-full w-full flex justify-center items-center rounded-4xl">
                <p className="text-center text-[80px] font-[700] text-[#FFFFFF] w-[60%]">
                  {" "}
            ...
            <SwiperSlide>
              {" "}
              <div className="pb-20 bg-[url('/assets/images/slide5.png')] bg-cover bg-center bg-no-repeat h-full w-full flex justify-center items-center rounded-4xl">
                <p className="text-center text-[80px] font-[700] text-[#FFFFFF] w-[60%]">
                  {" "}
